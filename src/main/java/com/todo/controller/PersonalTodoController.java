...
public class PersonalTodoController {
	...
	public TodoEntity3 updateTodo(@PathVariable("personal_id") Long personal_id,
			@PathVariable("content_id") Long content_id, @RequestBody TodoEntity3 todo) {
	...
	public void deleteTodo(@PathVariable("personal_id") Long personal_id, @PathVariable("content_id") Long content_id) {
